...
// journal's list + the file the current tool call touched. Pure fs-free merge —
// no spawn, no git (Phoenix #5). Paths are stored relative to cwd when inside it
// (readable in the recovery block), absolute otherwise. Deduped, order-preserving.
